...
ninja.data = [{
    ...
    section: "Navigation",
    handler: () => {
      window.location.href = "/chi541323.github.io%3E/";
    },
  },{id: "nav-projects",
          title: "Projects",
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/chi541323.github.io%3E/projects/";
          },
        },{id: "nav-cv",
          title: "cv",
          description: "",
          section: "Navigation",
          handler: () => {
            window.location.href = "/chi541323.github.io%3E/cv/";
          },
          ...
          section: "Projects",handler: () => {
              window.location.href = "/chi541323.github.io%3E/projects/2_Masque.html";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/chi541323.github.io%3E/projects/3_Gaiters.html";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/chi541323.github.io%3E/projects/4_PuPoP.html";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/chi541323.github.io%3E/projects/5_Aarnio.html";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/chi541323.github.io%3E/projects/6_ElastiLinks.html";
            },},{
        id: 'social-email',
        title: 'email',
        section: 'Socials',
        ...
        section: 'Socials',
        handler: () => {
          window.open("/chi541323.github.io>//feed.xml", "_blank");
        },
      },{
        id: 'social-scholar',
